...
async function run_graph1(date) {
    // executing the python script
    const python = await spawn('python3', ['./Python_Scripts/graph1.py', date]); // execute the python script
...
async function run_graph6(){
    const python = await spawn('python3', ['./Python_Scripts/graph6.py']); // execute the python script
...
module.exports = {run_graph1, run_graph2, run_graph5, run_graph3, run_graph6, run_graph4,};